...
describe('config.json', function () {
    ...
    describe('branding information',
        function () {
            ...
            it('config contains version information', function () {
                assert.isDefined(config.version);
                //later generated by major and minor + build number
                assert.isDefined(config.version.number);
            });
